        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user.Role==null) //El valor que recibe desde del page
                    {
                        await _userManager.AddToRoleAsync(user, DS.Role_Cliente); // Rol por defecto
                    }else
                    {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu email",
                        $"Por favor confirmar tu cuenta<a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Haz click en el elnlace</a>.");
